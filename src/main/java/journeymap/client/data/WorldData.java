...
public class WorldData extends CacheLoader<Class, WorldData> {
        ...
        try {
            ...
            if (!mc.isSingleplayer()) {
                try {
                    ...
                    final GuiScreen netHandlerGui = ReflectionHelper.getPrivateValue(NetHandlerPlayClient.class, netHandler, new String[]{"field_147307_j", "guiScreenServer"});
                    if (netHandlerGui instanceof GuiScreenRealmsProxy) {
                        ...
                        if (realmsScreen instanceof RealmsMainScreen) {
                            ...
                            final long selectedServerId = ReflectionHelper.getPrivateValue(RealmsMainScreen.class, mainScreen, new String[]{"selectedServerId"});
                            final List<RealmsServer> mcoServers = ReflectionHelper.getPrivateValue(RealmsMainScreen.class, mainScreen, new String[]{"mcoServers"});
    ...
    public static String getWorldName(final Minecraft mc, final boolean useLegacyName) {
        ...
        if (mc.isSingleplayer()) {
            ...
            worldName = Journeymap.clientWorld().getWorldInfo().getWorldName();
    ...
    public static List<DimensionProvider> getDimensionProviders(final List<Integer> requiredDimensionList) {
        try {
            ...
            final WorldProvider playerProvider = player.getEntityWorld().provider;
            ...
            providerList.sort(Comparator.comparingInt(DimensionProvider::getDimension));
            return providerList;
        } catch (Throwable t3) {
    ...
    public static String getSafeDimensionName(final DimensionProvider dimensionProvider) {
        ...
        try {
            ...
            return Constants.getString("jm.common.dimension", Journeymap.clientWorld().provider.getDimension());
        }
    }

    public static String getGameTime() {
        final long worldTime = Journeymap.clientWorld().getWorldTime() % 24000L;
        String label;
        if (worldTime < 12000L) {
    ...
    public WorldData load(final Class aClass) throws Exception {
        ...
        this.time = world.getWorldTime() % 24000L;
