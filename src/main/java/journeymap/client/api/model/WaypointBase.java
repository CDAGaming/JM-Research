...
public abstract class WaypointBase<T extends WaypointBase> extends Displayable implements IWaypointDisplay {
    ...
    public final T setLabel(final int color, final float opacity) {
        return this.setLabel(new MapText<>().setColor(color).setOpacity(opacity));
    }
    ...
    public Set<Integer> getDisplayDimensions() {
        if (this.displayDims != null) {
            return new HashSet<>(this.displayDims);
        }
        if (this.hasDelegate()) {
    ...
    public boolean equals(final Object o) {
        ...
        return com.google.common.base.Objects.equal(this.getGuid(), that.getGuid()) && com.google.common.base.Objects.equal(this.getIcon(), that.getIcon()) && com.google.common.base.Objects.equal(this.getLabel(), that.getLabel()) && Arrays.equals(this.getDisplayDimensions().toArray(), that.getDisplayDimensions().toArray());
    }
}
